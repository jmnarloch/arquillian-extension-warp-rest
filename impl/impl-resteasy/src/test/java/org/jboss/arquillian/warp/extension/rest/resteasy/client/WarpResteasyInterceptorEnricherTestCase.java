...
/**
 * Tests the {@link WarpResteasyInterceptorEnricher} class.
 *
 * @author <a href="mailto:jmnarloch@gmail.com">Jakub Narloch</a>
 */
@RunWith(MockitoJUnitRunner.class)
public class WarpResteasyInterceptorEnricherTestCase {

    /**
     * Represents the instance of tested class.
     */
    private WarpResteasyInterceptorEnricher instance;
    ...
    public void setUp() {
        ...
        instance = new WarpResteasyInterceptorEnricher();
    }

    /**
     * Tests the {@link WarpResteasyInterceptorEnricher#register(LoadableExtension.ExtensionBuilder)} method.
     */
    @Test
    public void shouldRegisterExtension() {
        ...
        // then
        verify(builder).service(WarpRestInterceptorEnricher.class, WarpResteasyInterceptorEnricher.class);
    }

    /**
     * Tests the {@link WarpResteasyInterceptorEnricher#enrichWebArchive(WebArchive)} method.
     */
    @Test
    public void shouldEnrichWebArchives() {
        ...
        // then
        verify(webArchive).addPackage(WarpResteasyInterceptor.class.getPackage());
    }
}
